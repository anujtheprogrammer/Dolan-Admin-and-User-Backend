...
class Navy extends Component {
    ...
    render() {
        ...
        <div>
               <div id="wrapper">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item" role="presentation"></li>
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="index.html"><i class="fas fa-tachometer-alt"></i><span>Dashboard</span></a><a class="nav-link" href="wallpaper.html"><i class="fa fa-trello"></i><span>Wallpaper</span></a></li>
                    <li
        ...
        <div className="flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="col-lg-6 mb-4">
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="progress mb-4">
                                <div class="progress-bar bg-success" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style={s267}><span class="sr-only">100%</span></div>
                            </div>
                        </div>
                    </div>
                    <div class="card shadow mb-4">
